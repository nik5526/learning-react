...
const Header = () => {
    ...
    return (
        <div className="flex justify-between items-center w-full h-[130px] bg-white z-10">
            <div className="logo">
                <img className="w-36 h-32" src={LOGO_URL} alt="Logo" />
            </div>
            <div className="m-4 p-4 "> 
                <ul className="flex gap-16 p-4 m-4 items-center font-serif font-semibold text-lg text-black ">
                    ...
                    <li className="style-none text-2xl  hover:text-gray-500">
                    ...
                    <li className="style-none text-2xl  hover:text-gray-500 cursor-pointer ">
                        {loggedInUser}
                    </li>
                </ul>
            </div>
